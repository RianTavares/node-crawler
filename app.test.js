...
// mocking values to test de methods
const feed = [
    {
        type: 'tag',
        name: 'item',
...
"feed":[
    {
        "description":[
            {
                "content":"https://s2.glbimg.com/alMLJ81HL53OQ8EpuMr87JTQ1nA=/620x413/e.glbimg.com/og/ed/f/original/2018/11/16/bmw_m340i_2.jpg",
                "type":"image"
            },
            {
                "content":" A BMW vai aproveitar o Salão do Automóvel de Los Angeles, nos Estados Unidos, para exibir uma nova versão do novo Série 3: o M340i. Equipado com um motor 3.0 de seis cilindros em linha que entrega até 382 cv, o modelo é o mais potente Série 3 produzido até agora, sem considerar o atual M3, que oferece 425 cv de potência.",
                "type":"text"
            },
            {
                "content":[
            ...
            {
                "content":" O carro tem torque de 51 kgfm e é capaz de acelerar de 0 a 100 km/h em 4,4 segundos. A velocidade máxima atingida é de 250 km/h, limitada automaticamente. A versão também vem com câmbio automático de oito velocidades - a montadora já adiantou que não será oferecida versão com transmissão manual desta vez.",
                "type":"text"
            },
            {
                "content":" Além disso, o modelo conta com tração traseira e integral (na opção xDrive), suspensão esportiva M Sport e discos de freios dianteiros de 348 mm e traseiros de 345 mm.",
                "type":"text"
            },
            {
                "content":"https://s2.glbimg.com/Ob5p4EOrXc4xSPJfnlhjn1mlyzA=/620x413/e.glbimg.com/og/ed/f/original/2018/11/16/bmw_m340i.jpg",
                "type":"image"
            },
            {
                "content":" Com o ínicio das vendas na Europa programadas para o segundo semestre de 2019, o M340i ainda não tem previsão de chegada ao Brasil. Por outro lado, o novo Série 3 3, que foi apresentado  no Salão de Paris, chega às concessionárias brasileiras no ano que vem - e a produção será nacional.",
                "type":"text"
            }
        ],
        "link":"https://revistaautoesporte.globo.com/Noticias/noticia/2018/11/com-quase-400-cv-novo-bmw-m340i-e-um-dos-serie-3-mais-potentes-ja-produzidos.html",
        "title":"Com quase 400 cv, novo BMW M340i é um dos Série 3 mais potentes já produzidos "
    }
]
}


test('it should return a reponse in json format', () => {
  expect(jsonCreator(feed)).toEqual(responseJson);
});
